...
<body>
	...
	<!--==================================================-->
	<div class="service-details-area wow fadeInUp" data-wow-delay="0.3s" data-wow-duration="1s">
		<div class="container">
			<div class="row">
				<div class="col-lg-4 col-md-8">
					<div class="widget-categories-box">
						...
						<div class="widget-categories-menu">
							<ul>
								<li><a href="service-details.html">CAR INSURANCE <span><i
									class="bi bi-chevron-double-right"></i></span></a></li>
								<li><a href="service-details.html"> LIFE INSURANCE <span><i
												class="bi bi-chevron-double-right"></i></span></a></li>
								<li><a href="service-details.html"> HOME INSURANCE<span><i
												class="bi bi-chevron-double-right"></i></span></a></li>
								<li><a href="service-details.html"> HEALTH INSURANCE <span><i
												class="bi bi-chevron-double-right"></i></span></a></li>
								<li><a href="service-details.html"> TAVEL INSURANCE <span><i
												class="bi bi-chevron-double-right"></i></span></a></li>
								<li><a href="service-details.html"> MARRIAGE INSURANCE <span><i
												class="bi bi-chevron-double-right"></i></span></a></li>
							</ul>
						</div>
					</div>
					...
					<div class="widget-download-box">
						<div class="widget-download-btn">
							<a href="#"><i class="bi bi-filetype-pdf"></i> Download PDF File</a>
						</div>
					</div>
				</div>
				<div class="col-lg-8 col-md-12">
					...
					<div class="service-details-title">
						<h4>MARRIAGE INSURANCE</h4>
					</div>
					<div class="service-detials-discription">
						<p>To be clear, Project Online is NOT a web-based version of Project Professional. Project
							Online is an entirely separate service that offers full portfolio and project management
							...
							Discover Community. Explore subscription benefits, browse training courses, learn how to
							secure</p>
						<p>To be clear, Project Online is NOT a web-based version of Project Professional. Project
							Online is an entirely separate service that offers full portfolio and project management
							tools on the web. It includes Project Web App, and can, depending on your subscription, also
					...
					<div class="row">
						...
						<div class="col-lg-6 col-md-6">
							<div class="service-list-title">
								<h4>Global Transaction Advisory</h4>
							</div>
							<div class="service-detials-list">
								<span>Customer engagement matters</span>
								<span>The Love Boat promis someg for Plan</span>
								<span>Research beyond the business plan</span>
								<span>Id risus pharetra est, at rhoncus</span>
								<span>Elit curabitur amet risus bibendum.</span>
								<span>Non saed velit dictum quam risus.</span>
							</div>
						</div>
					</div>
					<div class="service-details-title">
						<h4>Our Strengths And Advantages</h4>
					</div>
					<div class="service-detials-discription">
						<p>To be clear, Project Online is NOT a web-based version of Project Professional. Project
							Online is an entirely separate service that offers full portfolio and project management
