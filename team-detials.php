...
<body>
	...
	<!--==================================================-->
	<div class="team-details-area wow fadeInUp" data-wow-delay="0.3s" data-wow-duration="1s">
		<div class="container">
			<div class="row">
				<div class="col-lg-6 col-md-12">
					<div class="team-author-thumb">
						<img src="assets/images/team/team-details-thumb.jpg" alt="">
					</div>
				</div>
				<div class="col-lg-6 col-md-12">
					<div class="process-ber-plugin">
						<span class="process-bar">Success Rate - 80%</span>
						<div id="bar2" class="barfiller">
							<div class="tipWrap" style="display: inline;">
								<span class="tip"
									style="left: 382.959px; transition: left 7s ease-in-out 0s;">79%</span>
							</div>
							<span class="fill" data-percentage="79"
								style="background: rgb(22, 181, 151); width: 418.694px; transition: width 7s ease-in-out 0s;"></span>
						</div>
						<span class="process-bar">Complete Work - 50%</span>
						<div id="bar3" class="barfiller">
							<div class="tipWrap" style="display: inline;">
								<span class="tip"
									style="left: 382.959px; transition: left 7s ease-in-out 0s;">69%</span>
							</div>
							<span class="fill" data-percentage="69"
								style="background: rgb(22, 181, 151); width: 418.694px; transition: width 7s ease-in-out 0s;"></span>
						</div>
						<span class="process-bar">Satisfied Client - 95%</span>
						<div id="bar4" class="barfiller">
							<div class="tipWrap" style="display: inline;">
								<span class="tip"
									style="left: 382.959px; transition: left 7s ease-in-out 0s;">89%</span>
							</div>
							<span class="fill" data-percentage="89"
								style="background: rgb(22, 181, 151); width: 418.694px; transition: width 7s ease-in-out 0s;"></span>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-8 col-md-12">
					<div class="row author-info">
						<div class="col-lg-4 col-md-4">
							<div class="team-author-exprience">
								<ul>
									<li>
										<span>Name</span>
										<h4>Archer Graham</h4>
			...
			<div class="row">
				<div class="col-lg-4 col-md-6">
					<div class="team-single-box wow fadeInUp" data-wow-delay="0.4s" data-wow-duration="1s">
						...
						<div class="team-content">
							<h4><a href="team-detials.html">Woseph Carter</a></h4>
				...
				<div class="col-lg-4 col-md-6">
					<div class="team-single-box inner wow fadeInUp" data-wow-delay="0.6s" data-wow-duration="1s">
						...
						<div class="team-content">
							<h4><a href="team-detials.html">David Latham</a></h4>
							<span>Manager Designer</span>
						</div>
					</div>
				</div>
				<div class="col-lg-4 col-md-6">
					<div class="team-single-box inner2 wow fadeInUp" data-wow-delay="0.8s" data-wow-duration="1s">
						...
						<div class="team-content">
							<h4><a href="team-detials.html">Austice Smith</a></h4>
							<span>Manager Designer</span>
						</div>
					</div>
				</div>
