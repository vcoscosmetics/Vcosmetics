	...
	<section class="banner-section">
		<div class="banner-carousel owl-carousel">
			<div class="slide-item one">
				<div class="image-layer" style="background-image: url('assets/images/slider/banner.jpg');"></div>
				<div class="container">
			...
			<div class="row">
				...
				<div class="col-lg-3 col-md-6">
					<div class="feature-single-box wow fadeInUp" data-wow-delay="0.6s" data-wow-duration="1s">
						<div class="fetaure-icon">
							<img src="assets/images/service/feature-icon3.png" alt="">
						</div>
						<div class="feature-content">
				...
				<div class="col-lg-6 col-md-12">
					<div class="choose-thumb-items">
						<div class="choose-thumb wow fadeInLeft" data-wow-delay="0.4s" data-wow-duration="1s">
							<img src="assets/images/resource/choosepic2.jpg" style="height:371px; width: 373px;" alt="">
						</div>
						<div class="choose-thumb wow fadeInUp" data-wow-delay="0.4s" data-wow-duration="1s">
							<img src="assets/images/resource/choose2.jpg" style="height:257px; width:373px;" alt="">
						</div>
						<div class="choose-thumb three">
							<img src="assets/images/resource/choose3.jpg" style="height:452px; width:267px;" alt="">
						</div>
					</div>
				</div>
			</div>
	...
	<!-- <div class="insurance-area">
		<div class="container">
			...
			<div class="row insurance">
						...
						<div class="col-lg-12">
							<div class="tab insurance-list-tab">
								...
								<div class="tab_content">
									...
									<div class="tabs_item" style="display: none;">
										<div class="insurance-form">
											<form action="https://formspree.io/f/myyleorq" method="POST" id="ttime">
												<div class="row">
													<div class="col-lg-6">
														<div class="insurance-form-box">
													...
													<div class="col-lg-6">
														<div class="insurance-form-box">
															<label for="numbar">Phone</label><br>
															<input type="text" id="numbar" name="number">
														</div>
													</div>
													<div class="col-lg-6">
														<div class="insurance-form-box">
													...
													<div class="col-lg-6">
														<div class="insurance-form-box">
															<label for="option">Insurance Type</label><br>
										...
										<div class="insurance-form">
											<form action="https://formspree.io/f/myyleorq" method="POST" id="tech-time">
												<div class="row">
													<div class="col-lg-6">
														<div class="insurance-form-box">
															<label for="lname">Your Full Name</label><br>
													...
													<div class="col-lg-6">
														<div class="insurance-form-box">
															<label for="choose">Insurance Type</label><br>
				...
				<div class="col-lg-6 col-md-12">
					<div class="google-map wow fadeInUp" data-wow-delay="0.6s" data-wow-duration="1s">
						<iframe
							...
							width="1020" height="743" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
					</div>
				</div>
			</div>
		</div>
